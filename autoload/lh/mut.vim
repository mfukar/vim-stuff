"=============================================================================
" $Id: mut.vim 356 2011-01-08 02:58:10Z luc.hermitte $
" File:         autoload/lh/mut.vim                               {{{1
" Author:       Luc Hermitte <EMAIL:hermitte {at} free {dot} fr>
"		<URL:http://code.google.com/p/lh-vim/>
" Version:      2.2.1
" Created:      05th Jan 2011
" Last Update:  $Date: 2011-01-08 03:58:10 +0100 (sam., 08 janv. 2011) $
"------------------------------------------------------------------------
" Description:
...
"   == 2 : "{pattern}^r\t foo" -> "{the template}Â«Â» foo"
...
" s:InterpretValue() will interpret a sequence between Â¡.\{-}Â¡ {{{3
