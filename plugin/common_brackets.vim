"===========================================================================
" $Id: common_brackets.vim 173 2010-05-10 02:19:47Z luc.hermitte $
" File:     common_brackets.vim
" Author:   Luc Hermitte <MAIL:hermitte {at} free {dot} fr>
"       <URL:http://code.google.com/p/lh-vim/>
" Last Update:  Fri Jan 24, 2014 15:02 EET
" Version:  1.0.0
" Purpose:      {{{1
  ...
  while 1
    ...
    if (-1 != stridx("x([{<\"\\q",bracketsManip)) ||
     \ (key =~ "\\(\<F1>\\|\<Del>\\)")
      ...
      elseif bracketsManip == "\""     | call s:ChangeQuotes()
      elseif key == "\<F1>"
    redraw! " clear the msg line
    ...
    echo " *\"* -- change the current brackets pair to quotes \"\"\n"
